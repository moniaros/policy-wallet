 ...
 * insights (now absorbed into /protection, which inherited its boundaries in
 * V2-P2-03) was the one gap — a multi-await page (auth, entitlements,
 * gap-engine snapshot) with no loading state while every sibling had one.
 */
const DATA_ROUTES = [
    'protection',
    'dashboard',
