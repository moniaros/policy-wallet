...
export const guides: Guide[] = [
    ...
    },
    {
        ...
        datePublished: "2026-07-13",
        // 2026-08-26: extended with the objection window and the reader's own
        // evidence that cover was in force on the check date (SRC-012).
        // The ΑΑΔΕ attribution in the sections above is NOT resolved here —
        // see docs/growth/HALTS-GROWTH.md, HALT-G02.
