    ...
    el: {
        'upload-policy': {
            ...
            sections: [
                ...
                {
                    heading: 'Βήμα 1: Μετάβαση στα ασφαλιστήριά σας',
                    text: 'Από τον πίνακα ελέγχου, ανοίξτε τα «Ασφαλιστήρια» από το κεντρικό μενού. Εκεί βρίσκονται όλα τα ασφαλιστήριά σας.',
                },
                {
                    heading: 'Βήμα 2: Προσθήκη Νέου Ασφαλιστηρίου',
                    text: 'Κάντε κλικ στο μεγάλο πετρόλ κουμπί "Προσθήκη ασφαλιστηρίου". Θα σας παρουσιαστούν δύο επιλογές: "Μεταφόρτωση εγγράφου" και "Χειροκίνητη προσθήκη". Επιλέξτε "Μεταφόρτωση εγγράφου" — είναι ο πιο γρήγορος τρόπος.',
                },
                {
        ...
        'premium-features': {
            ...
            subtitle: 'Αποκτήστε την πλήρη ανάλυση AI και περισσότερο χώρο ασφαλιστηρίων με τα πληρωμένα πλάνα.',
            readTime: '5 λεπτά',
        ...
        'notifications': {
            ...
            sections: [
                ...
                },
                {
                    ...
                    text: 'Οι ειδοποιήσεις έρχονται με email. Αν τις επιτρέψετε στον περιηγητή σας, μπορείτε να τις λαμβάνετε και ως push — δεν χρειάζεται εφαρμογή. Μεταβείτε στις Ρυθμίσεις -> Ειδοποιήσεις για να επιλέξετε ποιες θέλετε.',
                }
            ]
        },
        'install-pwa': {
            ...
            sections: [
                {
                    ...
                    text: 'Το PolicyWallet είναι μια Προοδευτική Εφαρμογή Ιστού. Αυτό σημαίνει ότι μπορείτε να την εγκαταστήσετε απευθείας από τον περιηγητή σας χωρίς να επισκεφτείτε ένα κατάστημα εφαρμογών. Λειτουργεί εκτός σύνδεσης και καταλαμβάνει ελάχιστο χώρο.',
                },
                {
