...
export function getDeletionApprovedEmail(language: DsrEmailLanguage): DsrEmail {
    if (language === "el") {
        ...
        const paragraphs = [
            ...
            "Με την ολοκλήρωση θα διαγραφούν τα ασφαλιστήρια, τα έγγραφα και τα προσωπικά σας δεδομένα. Ό,τι οφείλουμε νομίμως να διατηρήσουμε (π.χ. φορολογικά παραστατικά για 5 έτη) διατηρείται ανωνυμοποιημένο.",
...
export function getDeletionCompletedEmail(language: DsrEmailLanguage): DsrEmail {
    if (language === "el") {
        ...
        const paragraphs = [
            ...
            "Διαγράφηκαν: τα ασφαλιστήρια και τα έγγραφά σας, το προφίλ και οι προτιμήσεις σας, τα στοιχεία σύνδεσης και οι ενεργές συνεδρίες, καθώς και οι μέθοδοι πληρωμής. Τυχόν ενεργή συνδρομή ακυρώθηκε.",
