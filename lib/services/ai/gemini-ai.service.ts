...
`
      ...
      const fileDataUri = `data:${document.mimeType};base64,${document.data}`
          ...
          messages: [
            {
              ...
              content: [
                ...
                { type: 'file', data: fileDataUri, mimeType: document.mimeType } as any
              ]
            }
          ],
          temperature: 0.1
  ...
  async analyzeGaps(
    ...
    try {
      const modelName = env.GEMINI_MODEL_GAP_ANALYSIS
