...
export const el = {
    ...
    common: {
        ...
        aiProcessingConsent: {
            title: 'Συγκατάθεση για ανάλυση AI',
            body: 'Για να αναλύσουμε αυτό το συμβόλαιο, αποστέλλουμε το έγγραφό σας — το οποίο ενδέχεται να περιλαμβάνει δεδομένα ειδικής κατηγορίας, όπως πληροφορίες υγείας — σε τρίτο πάροχο AI. Το επεξεργαζόμαστε αποκλειστικά για την εξαγωγή καλύψεων, τον εντοπισμό κενών και τη δημιουργία της ανάλυσής σας. Μπορείτε να ανακαλέσετε τη συγκατάθεση οποτεδήποτε από τις ρυθμίσεις του λογαριασμού σας.',
            agree: 'Συμφωνώ — ανάλυση του συμβολαίου μου',
            cancel: 'Όχι τώρα',
            recording: 'Αποθήκευση της συγκατάθεσής σας…',
            error: 'Δεν ήταν δυνατή η αποθήκευση της συγκατάθεσης. Δοκιμάστε ξανά.',
            required: 'Απαιτείται συγκατάθεση επεξεργασίας AI πριν από την ανάλυση αυτού του συμβολαίου.',
        },
    },
    // Navigation
    nav: {
