...
export const en: TranslationKeys = {
    ...
    wallet: {
        ...
        summary: 'Summary',
        summaryFallback: 'No summary provided for this policy. Our AI analysis will populate this section as soon as your document is processed.',
        policyId: 'Policy ID',
        starts: 'Starts',
        ends: 'Ends',
        actionItems: 'Action Items',
        reviewRenewal: 'Review renewal options soon',
        downloadContract: 'Download latest contract',
