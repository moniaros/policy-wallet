...
export const en: TranslationKeys = {
    ...
    dashboard: {
        home: {
            title: 'My protection',
            // The portfolio score's ONE canonical name (score-vocabulary test).
            protectionScore: 'Protection score',
            heroKicker: 'Protection status',
            heroCta: 'Review my protection',
            heroDeltaSince: '{delta} since {date}',
            heroReasonKicker: 'Biggest factor',
            heroReasonFell: '{category}: down {points} points since your previous assessment.',
            heroReasonRose: '{category}: up {points} points since your previous assessment.',
            heroAreasOne: '1 area may need review',
            factTotalOne: '1 policy',
            factTotalMany: '{count} policies',
            factExpiredOne: '1 has expired',
            factExpiredMany: '{count} have expired',
            factExpiringOne: '1 expires soon',
            factExpiringMany: '{count} expire soon',
            ...
            heroAreasMany: '{count} areas may need review',
            heroPoliciesOne: '1 policy on file',
            heroPoliciesMany: '{count} policies on file',
            heroAnalyzingOne: '1 still being analyzed',
            heroAnalyzingMany: '{count} still being analyzed',
            ...
            heroIndeterminateTitle: 'We don’t know enough about you yet',
            heroIndeterminateBody: 'Answer a few short questions about your life so your score can reflect it honestly.',
            heroIndeterminateCta: 'Complete my profile',
    ...
    settings: {
        ...
        plan: {
            ...
            features: {
                ...
                advancedAnalytics: 'Track your protection score over time',
