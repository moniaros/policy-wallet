...
export const en: TranslationKeys = {
    ...
    settings: {
        ...
        riskReview: {
            ...
            scoreThen: 'Your score when this opened',
            cta: 'Review my details',
            complete: 'Mark as reviewed',
            dismiss: 'Not now',
            completed: 'Thanks — your review is recorded.',
            dismissed: 'We will ask again when something changes.',
            failed: 'Could not update the review. Please try again.',
        ...
        quietHours: {
            ...
            from: 'From',
            to: 'Until',
            urgentNote: 'Urgent alerts — a failed payment, a lapsed policy, a change to your login — always come through.',
            saved: 'Quiet hours updated.',
            saveFailed: 'Could not save quiet hours. Please try again.',
        ...
        push: {
            ...
            unavailable: 'Push notifications are not configured on this deployment yet.',
