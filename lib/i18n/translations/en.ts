...
export const en: TranslationKeys = {
    ...
    nav: {
        ...
        home: 'Home',
        wallet: 'My policies',
        walletShort: 'Policies',
        protection: 'Cover & gaps',
        protectionShort: 'Cover',
        myAgent: 'My advisor',
        agentShort: 'Advisor',
        policies: 'Policies',
        coverage: 'Coverage',
    ...
    auth: {
        ...
        signInPage: {
            ...
            passkeyOrPassword: 'or with your password',
            passkeyNeedsEmail: 'Enter your email first to use your passkey.',
            passkeyUnavailable: 'No passkey exists for this address. Sign in with your password and register one from Settings.',
            passkeyFailed: 'Passkey sign-in did not complete. Try again or sign in with your password.',
    ...
    wallet: {
        ...
        addedByAdvisor: 'Document added by your advisor',
        quickFactsLabel: 'Key coverage facts',
        fromFamilyMember: 'From {name}',
        privateToOwner: 'Private — outside the family wallet',
        privateToOwnerHint: 'Members of your family wallet will not see it.',
        nickname: 'Policy name',
        nicknameHint: 'Optional. A name of your own to tell it apart, e.g. “Maria’s car”.',
        sortByRenewal: 'Renewal date',
        sortByInsurer: 'Insurer',
        sortByType: 'Insurance type',
        allInsurers: 'All insurers',
        insurerFilterLabel: 'Filter by insurer',
        ...
        portfolioReport: {
            button: 'Export portfolio',
            title: 'My insurance portfolio',
            ...
            footer: 'The details are as your policies record them in PolicyWallet.',
        },
        policyDetailsPage: {
            ...
            contactInsurerVerified: 'Insurer customer service (verified number)',
            ...
            quoteRequested: 'Request recorded, but no advisor has access to this policy. Share it to get a quote.',
            quoteRequestedAgent: 'The request was sent to your advisor and opened a thread.',
            ...
            noteTitle: 'My note',
            noteHint: 'Only you can see it. It is not shared with your advisor or your family wallet.',
            notePlaceholder: 'e.g. The advisor said the renewal arrives at the end of May.',
            noteSave: 'Save',
            noteSaved: 'Saved.',
            noteError: 'Could not save. Try again.',
            digitalCardLink: 'Digital card',
            compareTitle: 'Compare with the previous document',
            compareIntro: 'What the newer document changes against the previous one, as both were read.',
            comparePremium: 'Premium',
            compareSums: 'Amounts',
            compareTerms: 'Terms and covers',
            compareNoChanges: 'No differences were found in the fields that were read.',
            compareAdded: 'added',
        ...
        addPolicyForm: {
            ...
            chooseType: 'What type of policy is this?',
            takePhoto: 'Take a photo of the document',
        },
        batchUpload: {
    ...
    recommendationsPage: {
        ...
        subtitle: 'What you can do to strengthen your protection — based on your policies and what you have told us.',
        allProtection: 'See all of your protection',
        unavailable: 'We could not load your recommendations right now. Please try again shortly.',
    },
    protection: {
        title: 'Cover & gaps',
        subtitle: 'What protects you today, where protection is partial and what is missing — based on your policies and what you have told us.',
        lensAria: 'Protection view',
        lensByBranch: 'By line',
        lensByRisk: 'By risk',
        // «Cover & gaps» as a story (goal series, 2026-09-07) — see el.ts for the rules.
        summary: {
            title: 'Your picture at a glance',
            denominatorExpected: 'of {n} categories that concern you or in which you hold a policy',
            ...
            meaning: {
                ...
                finding: 'You hold a policy, but the check found something missing.',
                no_policy: 'It concerns you, but we have not seen a policy for it.',
                not_checked: 'You hold something here, but it has not been checked yet.',
            },
        },
        status: {
            appears_covered: 'Appears covered',
            finding: 'Partial cover',
            no_policy: 'No policy',
            not_checked: 'Not checked yet',
            under_review_only: 'Findings under review',
            held_elsewhere: 'Outside PolicyWallet',
        },
        statusCaveats: {
            checkedPoints: 'We checked {covered} of {checked} coverage points and none showed something missing.',
            indeterminate: '{n} could not be checked.',
            indeterminateOne: '1 could not be checked.',
            notRecorded: '{n} details are not recorded in the document.',
            notRecordedOne: '1 detail is not recorded in the document.',
            limitsUnread: 'We have not read the limits and exclusions yet.',
            expiringSoon: 'Ends soon.',
            findingCount: 'You hold a policy, but the check found {n} points missing.',
            findingCountOne: 'You hold a policy, but the check found 1 point missing.',
            noPolicy: 'We have not seen a policy for this yet.',
            lapsedOnly: 'The policy you had has ended — we do not know whether it was renewed.',
            underReviewOnly: 'The findings here await classification — they do not count yet.',
            heldElsewhere: 'You told us you hold this outside PolicyWallet.',
            unauthored: 'We have no checks yet for this type of policy.',
            no_coverage_checks: 'The checks here concern document details only, not cover.',
            never_analysed: 'Our checks have not read it yet.',
            unread: 'The document was not read as a policy.',
            stale_failed: 'The latest check failed — what you see is from an earlier one.',
            stale_blocked: 'The latest check did not run — what you see is from an earlier one.',
        ...
        categories: {
            title: 'Your cover by category',
            lead: 'What each category protects and where you stand.',
            view: 'View',
            seeWhatCouldProtect: 'See what could protect you',
            otherTitle: 'Other categories',
            otherLead: 'They do not seem to concern you from what we know — look here if something changes.',
            emptyFiltered: 'No category matches this filter.',
            clearStatus: 'All statuses',
            onePolicy: '1 policy',
            policyCountN: '{count} policies',
        },
        filters: {
        ...
        gaps: {
            title: 'Worth a look',
            lead: 'Each point explains what it means for you and what you can do.',
            meaning: 'What it means for you',
            why: 'Why it matters',
            concerns: 'Concerns: {area}',
            review: 'View policy',
            dismiss: 'Ignore',
            dismissed: 'The point was hidden.',
            dismissFailed: 'The change did not go through. Please try again.',
            ...
            allClearExcludedOne: '1 not checked yet.',
            notAnalysed: 'We have not checked your policies yet.',
            notAnalysedHint: 'The check starts as soon as you upload or refresh a policy.',
            notAnalysedLocked: 'Unlock full analysis',
            noPolicies: 'Add a policy so we can see what you are missing.',
            excludedExpiredTitle: 'Expired policies do not count as cover',
            excludedExpiredBody: 'The picture covers only what is in force today. Excluded: {list}',
            engineUnavailable: 'Recommendations did not load right now. Everything below comes from your policies.',
        },
        why: {
            legislative: 'The law requires it.',
            contractual: 'Your policy provides for it.',
            market: 'Common in the market — not mandatory.',
            under_review: 'Under review — we do not count it yet.',
        },
        life: {
            title: 'Based on your life',
            lead: 'What you tell us changes what we check and what we suggest.',
        },
        improve: {
            title: 'How you can strengthen your protection',
            recommendations: 'See my recommendations',
            recommendationsCount: '{n} recommendations',
            recommendationsCountOne: '1 recommendation',
        ...
        nextStep: {
            ...
            add_first: { body: 'Add your first policy so we can see what protects you.', cta: 'Add a policy' },
            analyse: { body: 'You hold policies we have not checked yet.', cta: 'Check my policies' },
            unlock: { body: 'The full check of your policies belongs to an upgraded plan.', cta: 'Unlock full analysis' },
            gaps: { body: 'The check found points worth a look.', cta: 'See my gaps' },
            answer: { body: 'A few answers will help us check what concerns you.', cta: 'Answer {n} questions', ctaOne: 'Answer 1 question' },
            recommendations: { body: 'We found nothing missing — there are recommendations to strengthen your protection, though.', cta: 'See my recommendations' },
            add_more: { body: 'Add the rest of your policies for the full picture.', cta: 'Add a policy' },
        },
        ...
        attention: {
            ...
            detail: {
                ...
                needs: {
                    title: 'Need against cover',
                    shortfall: 'The life sum on your policies is {cover}. The need we computed is {need} — a shortfall of {shortfall}.',
                    adequate: 'The life sum on your policies is {cover} — it meets the need we computed ({need}).',
                    need: 'Need: annual income {income} × {years} years, because the household leans on it {dependency}, with {dependants} dependants. The income is the figure you gave us{when}.',
                    needWhen: ' ({month})',
                    coverPage: 'The sum is stated in the policy on page {page}, and was confirmed in its text.',
                    coverNoPage: 'The sum is stated in the policy and was confirmed in its text.',
                    assumption: 'The {years} years are an assumption, not a verdict — it changes if you tell us otherwise.',
                    questionFacts: 'To check whether the life sum is enough, we need: {facts}.',
                    facts: {
                        dependants: 'how many dependants you have',
                        income: 'your annual income',
                        income_dependency: 'how far the household leans on it',
                    },
                    questionCitation: 'We read a life sum of {cover}, but it was not confirmed in the policy text — until the next analysis this stays a question, not a finding.',
                    questionNeedEvidence: 'The need ({need}) was computed from figures you did not state exactly ({weaker}) — a question, not a finding. Confirm them and the check becomes one.',
                    notApplicable: 'With no dependants we do not compute an income-replacement need.',
                    notCheckable: 'We have not read a life sum on a policy in force, so there is nothing to compare.',
                    dependency: { primary: 'mostly', shared: 'about half', minor: 'a little' },
                },
    ...
    composition: {
        ...
        staleCatalogue: 'This analysis ran on {date}. Checks have been added since — a new analysis will include them.',
        staleCatalogueNoDate: 'Checks have been added since this analysis — a new analysis will include them.',
    ...
    analysis: {
        ...
        report: {
            ...
            summaryUnderReview: '· Additionally, {count} findings await review',
            mechanics: {
        ...
        status: {
            ...
            pollTimeoutHint: 'This is taking longer than usual. The analysis continues and we will notify you when it is ready.',
    ...
    dashboard: {
        home: {
            checkupNudgeTitle: 'Your annual health check-up',
            checkupNudgeBody: 'Your health policy records an annual check-up you have not marked as done this year.',
            checkupNudgeBodyUnconfirmed: 'Your health policy appears to include an annual check-up. This needs confirmation from the terms or your advisor.',
            checkupNudgeCta: 'See how to book it',
            title: 'Your insurance picture',
            heroKicker: 'At a glance',
            ...
            factUnassessedOne: '1 not assessed',
            factUnassessedMany: '{count} not assessed',
            factUnassessedWhy: 'no authored checks for the branch',
            noGapsAmongAssessedOne: 'We checked 1 policy and found no gaps.',
            noGapsAmongAssessedMany: 'We checked {assessed} policies and found no gaps.',
            assessmentExcludedOne: '1 policy has not been checked yet (no analysis, or no checks available for its branch).',
            assessmentExcludedMany: '{excluded} policies have not been checked yet (no analysis, or no checks available for their branch).',
            noGapsNothingAssessed: 'We have not checked any policy yet — there is nothing to count.',
            ...
            renewalTimeline: 'Renewals & reminders',
            ...
            planStepAnalysisTitle: 'See what your policies cover',
            planStepAnalysisBody: 'See what we found in your coverage.',
            planStepGapsTitle: 'Explore your insurance gaps',
            ...
            planStepNotificationsTitle: 'Turn on reminders',
            planStepNotificationsBody: 'Get reminders for renewals and changes.',
            ...
            severityLow: 'low',
            subtitle: 'The whole picture in one place. More certainty for today and tomorrow.',
            greeting: 'Hello, {name}.',
            nextStepTitle: 'On to the next step',
            nextStepRecommendationsBody: 'We have recommendations ready for you, based on your policies and what you have told us.',
            nextStepRecommendationsCta: 'See my recommendations',
            nextStepRenewalBody: 'You have a renewal within the next 30 days. See what it needs before it ends.',
            nextStepRenewalCta: 'See renewals',
            nextStepAddMoreBody: 'Add the rest of your policies so we have the full picture and sharper recommendations.',
            nextStepAddMoreCta: 'Add a policy',
            nextStepHow: 'See how it works',
            alertLead: 'Based on the check of your policies, we found points worth a look.',
            alertCta: 'See my gaps',
            planCurrentStep: 'Next step',
            quickActionsTitle: 'Quick actions',
            quickActionAdd: 'Add a policy',
            quickActionGaps: 'See my gaps',
            quickActionRecommendations: 'Get recommendations',
            quickActionReminders: 'Set up reminders',
            preventiveTitle: 'A calmer tomorrow starts today.',
            preventiveBodyWithRecs: 'See how you can strengthen protection for yourself and the people you love, based on your policies and what you have told us.',
            preventiveBodyNoRecs: 'When you add a policy or something in your life changes, we will show you where your protection can be strengthened.',
            preventiveCta: 'See my recommendations',
            preventiveCtaNoRecs: 'See my protection',
            microTip: 'The right insurance cover protects not only what you have, but also what you want to achieve.',
        },
        greeting: {
    ...
    settings: {
        ...
        nav: {
            ...
            family: { label: 'Family wallet', description: 'Who sees your policies with you' },
        ...
        deleteFinalDesc: 'The request will be sent for review and your account with all its data will be permanently deleted. You can withdraw it while it is pending.',
    ...
    agentDashboard: {
        ...
        inRenewalsAtRisk: "estimated commission from pending renewals",
    ...
    agentPages: {
        ...
        policyDetail: {
            ...
            acordVerified: 'AI-extracted information',
            lastCheck: 'Last Check',
            verificationOverview: 'Verification Overview',
            verificationOverviewDesc: 'Information read by AI from the document. Extraction does not mean a person has confirmed it.',
            contractInsurer: 'Insurer',
            premiumFound: 'Premium Found',
            structuredCoverages: 'Structured Coverages',
            deductible: 'Deductible',
    ...
    offline: {
        title: 'Offline',
        intro: 'There is no network connection. These are the phone numbers your policies record, as saved the last time you opened your wallet.',
        nothingCached: 'No numbers are saved yet. Open your wallet once while connected.',
        asOf: 'Saved: {when}',
        endsOn: 'Ends on {date}',
        unknownInsurer: 'Insurer',
        ...
        kinds: {
            ...
            roadside: 'Roadside assistance',
            coordination: 'Coordination centre',
            technical: 'Technical assistance',
            emergency: 'Emergency assistance',
            insurer: 'Insurer customer service',
        },
    },
    family: {
        title: 'Family wallet',
        intro: 'Share your wallet with a spouse or partner: you see and manage the policies together. Anything you keep private stays yours alone.',
        visibilityTitle: 'What your family can see',
        visibilityRule: 'Each member sees and edits all your policies except the ones you marked private ({n} private today). Only you can delete.',
        managePrivate: 'Choose what stays private on each policy',
        membersTitle: 'Members of your wallet',
        noMembers: 'You have not added any member yet.',
        since: 'Since {date}',
        pendingSince: 'Invitation sent {date}',
        remove: 'Remove',
        revokeInvite: 'Cancel',
        inviteLabel: 'Member email',
        invitePlaceholder: 'spouse or partner email',
        inviteCta: 'Send invitation',
        inviteSent: 'Invitation sent.',
        inviteSentNoEmail: 'The invitation was created, but the email was not delivered. Try again later.',
        inviteRevoked: 'Invitation cancelled.',
        ended: 'Access ended.',
        upgradeToInvite: 'Inviting a member is part of the paid plans.',
        upgradeCta: 'See the plans',
        membershipsTitle: 'Wallets you belong to',
        noMemberships: 'You do not belong to another wallet.',
        leave: 'Leave',
        errors: {
            INVALID_EMAIL: 'Enter a valid email.',
            SELF: 'You cannot invite yourself.',
            UPGRADE_REQUIRED: 'Inviting a member is part of the paid plans.',
            RATE_LIMITED: 'Too many invitations in a short time. Try later.',
    ...
    wellness: {
        ...
        checkupStated: 'The policy records an annual health check-up.',
        checkupStatedNot: 'The policy records that no annual check-up is included.',
        checkupNotRecorded: 'Whether an annual check-up is included is not recorded — check your policy.',
        statusLabel: 'Check-up status',
        status: { available: 'Not done this year', scheduled: 'Scheduled', completed: 'Done this year' },
        bookVia: 'Call the coordination centre',
        noCentrePhone: 'No coordination centre phone is recorded on the policy.',
        assessmentTitle: 'Short self-assessment',
        assessmentIntro: 'Nine questions. The result is an indicative attention score per category from a fixed table — not a model and not medical advice.',
        consentLabel: 'I agree to my answers (health data) being stored so I can see the result. I can delete them at any time.',
        consentRequired: 'Your consent is needed to store the answers.',
        ...
        retake: 'New self-assessment',
        lastTaken: 'Last self-assessment: {date}',
        notDiagnosis: 'The score is indicative and not a diagnosis. Discuss it with your doctor.',
        worthRaising: 'Worth asking your doctor about',
        categories: { cardiovascular: 'Cardiovascular', metabolic: 'Metabolic', musculoskeletal: 'Musculoskeletal' },
        bands: { low: 'low attention', moderate: 'moderate attention', elevated: 'elevated attention' },
        checks: {
            blood_pressure: 'Blood pressure check',
            lipid_panel: 'Lipid panel',
            glucose: 'Glucose test',
            gp_discussion: 'A conversation with your doctor',
        ...
        questions: {
            ...
            familyCardio: 'Cardiovascular disease in a parent or sibling',
            familyDiabetes: 'Diabetes in a parent or sibling',
            backPain: 'Back or joint pain',
        },
        options: {
            ageBand_18_29: '18–29', ageBand_30_39: '30–39', ageBand_40_49: '40–49', ageBand_50_59: '50–59', ageBand_60_plus: '60+',
            sex_female: 'Female', sex_male: 'Male', sex_other: 'Other',
            smoking_never: 'Never', smoking_former: 'Former', smoking_current: 'Current',
            activity_low: 'Little', activity_moderate: 'Moderate', activity_high: 'A lot',
            bmiBand_under: 'Below normal', bmiBand_normal: 'Normal', bmiBand_over: 'Above normal', bmiBand_obese: 'Well above',
            bloodPressure_normal: 'Normal', bloodPressure_high: 'High', bloodPressure_unknown: "Don't know",
            familyCardio_no: 'No', familyCardio_yes: 'Yes', familyCardio_unknown: "Don't know",
            familyDiabetes_no: 'No', familyDiabetes_yes: 'Yes', familyDiabetes_unknown: "Don't know",
            backPain_no: 'No', backPain_sometimes: 'Sometimes', backPain_often: 'Often',
        },
        calendarTitle: 'Preventive checks',
        calendarNeedsAssessment: 'The calendar appears after the self-assessment, because it depends on the age and sex you state.',
        everyYears: 'General guidance: every {n} year(s)',
        markDone: 'Done',
        markUndone: 'Undo',
        calendarSource: 'General preventive guidance for adults. Whether a check is covered is decided by your policy — confirm with your doctor and your insurer.',
        benefit: {
            kicker: 'Benefit reminder',
            title: 'Annual health check-up',
            confirmed: 'Your policy {label} states an annual health check-up.',
            needsConfirmation: 'Your policy {label} appears to include an annual health check-up. This needs confirmation from the terms or your advisor.',
            unverifiedFalse: 'It is not clear whether the policy {label} includes an annual check-up. This needs confirmation from the terms or your advisor.',
            statedNotIncluded: 'The policy {label} states that it does not include an annual check-up.',
            notRecorded: 'Whether the policy {label} includes an annual check-up was not recorded. This does not mean it is not covered.',
            expired: 'The policy {label} has expired. The check-up it stated applied to its cover period.',
            conditionsUnknown: 'Frequency, limits and conditions: needs confirmation.',
            conditionsKnown: 'As recorded: {limits}.',
            detailsIntro: 'As the policy states them:',
            detailLabels: { frequency: 'Frequency', limitAmount: 'Limit', tests: 'Tests', network: 'Where', waitingPeriodDays: 'Waiting period', conditions: 'Conditions' },
            daysValue: '{n} days',
            termUnverified: 'not found verbatim in the document',
            coreMissing: 'Anything not listed here needs confirmation.',
            fromDocument: 'From the policy',
            pageAbbrev: 'p.',
            actionTerms: 'See what the policy says',
            actionCall: 'Call the coordination centre',
            actionCallNote: 'as recorded in the policy',
            actionCallInsurer: 'Call the insurer',
            actionCallInsurerNote: 'verified customer-service number of {insurer}; the policy states none of its own',
            actionAsk: 'Ask your advisor about the terms',
            askSent: 'Your question was sent to your advisor.',
            askNeedsPlan: 'Messaging your advisor in the app is available on paid plans.',
            noPhone: 'The policy records no coordination-centre phone.',
            noBooking: 'Appointments are not booked through the app.',
            intentLabel: 'What would you like to do?',
            intents: { considering: 'I will look into it', done: 'Done', not_relevant: 'Not for me', later: 'Later' },
            remindPrompt: 'When should we remind you?',
            remindSave: 'Save',
            confirmedLater: 'We will remind you on {date}.',
            confirmedDone: 'Marked as done for {year}.',
            confirmedNotRelevant: 'You will not see it again this year.',
            confirmedConsidering: 'Noted.',
            undo: 'Undo',
            noHealthPolicy: 'When you add a health policy, the prevention benefits it states will appear here.',
            noPolicy: 'Add your first policy to see its benefits.',
            addPolicy: 'Add a policy',
            homeCta: 'See the benefit',
            reminderTitle: 'Your annual check-up',
            reminderBody: 'You asked to be reminded about the annual check-up your policy {label} states.',
        },
        nudge: {
            kicker: 'A small step for today',
            dismiss: 'Not today',
            hidden: 'Fine, see you tomorrow.',
            pushLabel: 'One small reminder a day',
            pushHint: 'In the morning, once. You can stop it whenever you like.',
            pushOn: 'You will get one reminder in the morning.',
            pushOff: 'Daily reminders stopped.',
            disclaimer: 'General everyday ideas, not medical advice.',
            pushTitle: 'A small step for today',
        },
        nudges: {
            move_walk15: 'Take a 15-minute walk today.',
            move_stairs: 'Take the stairs instead of the lift once today.',
            move_stretch: 'Stand up and stretch for two minutes.',
            move_afterMeal: 'Take a short walk after a meal.',
            move_stopEarly: 'Get off one stop early and walk the rest of the way.',
            move_shoulders: 'Do ten gentle shoulder rolls.',
            water_glassNow: 'Drink a glass of water now.',
            water_bottle: 'Keep a bottle of water near you today.',
            water_morning: 'Start your morning with a glass of water.',
            water_swapSoda: 'Swap one soft drink for water today.',
            water_withMeals: 'Have a glass of water with each meal.',
            water_beforeTask: 'Fill a glass of water before your next task.',
            sleep_screenOff: 'Put the screen away half an hour before bed.',
            sleep_sameTime: 'Go to bed at the same time as yesterday.',
            sleep_airRoom: 'Air the bedroom for a few minutes before you sleep.',
            sleep_phoneOut: 'Leave your phone outside the bedroom tonight.',
            sleep_dimLights: 'Dim the lights an hour before bed.',
            sleep_noLateCoffee: 'Keep coffee for the morning today.',
            rest_breaths: 'Take five slow, deep breaths.',
            rest_screenBreak: 'Take a five-minute break from the screen.',
            rest_daylight: 'Step out into daylight for a few minutes.',
            rest_callSomeone: 'Call someone who makes you smile.',
            rest_farLook: 'Look at something far away for twenty seconds to rest your eyes.',
            rest_oneGoodThing: 'Note one thing that went well today.',
            food_fruit: 'Add a piece of fruit to one of your meals today.',
            food_halfVeg: 'Fill half your plate with vegetables at one meal.',
            food_noScreen: 'Eat one meal today away from screens.',
            food_nuts: 'Choose a handful of nuts instead of a sweet.',
            food_slowly: 'Eat one meal more slowly today.',
            food_prepSnack: 'Prepare a fruit snack for tomorrow today.',
        },
        share: {
            title: 'Share with your advisor',
            intro: 'You can show your advisor your health picture, so they can suggest whether your policy needs changes.',
            advisorLabel: 'Advisor',
            scopeAssessment: 'Self-assessment results',
            scopeProfile: 'Profile health details',
            scopeAssessmentMissing: 'You have not taken a self-assessment yet.',
            consent: 'I agree that {advisor} may see the details I selected. This is sensitive health data. I can withdraw the share at any time.',
            submit: 'Share',
            shared: 'Shared with {advisor} on {date}.',
            lastViewed: 'Last viewed: {date}',
            notViewed: 'Not viewed yet.',
            revoke: 'Withdraw share',
            revokeConfirm: 'Your advisor will no longer see these details.',
            revoked: 'The share was withdrawn.',
            noAdvisor: 'You have no connected advisor. You can only share with an advisor you work with.',
            nothingSelected: 'Select at least one item to share.',
            failed: 'The share did not complete. Try again.',
        },
        advisorView: {
            title: 'Health picture shared by the customer',
            sharedOn: 'Shared {date}. The customer can withdraw it.',
            assessment: 'Self-assessment of {date}',
            ...
            bmiBands: { under: 'Below normal', normal: 'Normal', over: 'Above normal', obese: 'Well above' },
            smokingValues: { non_smoker: 'Non-smoker', smoker: 'Smoker', former_smoker: 'Former smoker' },
            activityValues: { sedentary: 'Sedentary', moderate: 'Moderate', active: 'Active', very_active: 'Very active' },
            codes: { diabetes: 'Diabetes', hypertension: 'Hypertension', heart_disease: 'Heart disease', cancer: 'Cancer', asthma: 'Asthma', stroke: 'Stroke', high_cholesterol: 'High cholesterol' },
            note: 'An indicative picture from the customer, not a medical document. Your suggestions for the policy go through the conversation.',
            notificationTitle: 'Health picture shared',
            notificationBody: 'A customer shared their health picture with you.',
        },
    },
    onboarding: {
        protectionProfile: {
