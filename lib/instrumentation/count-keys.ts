...
export const FACT_KEYS: Record<string, string> = {
    ...
    "ledger.findingsShown": "Ledger line: findings surfaced this year (finding.shown).",
    "ledger.benefitsSurfaced": "Ledger line: benefits surfaced on /money (benefit.surfaced) — successor spelling of ledger.benefitsShown.",
    "ledger.helpRequests": "Ledger line: consented help requests to the adviser (advisor.help_requested).",
