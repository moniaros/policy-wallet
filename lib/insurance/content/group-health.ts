...
export const groupHealthContent: BranchContent = {
    ...
    tagline: {
        el: 'Το ομαδικό της δουλειάς είναι συνήθως η κάλυψη που χρησιμοποιείς πιο συχνά και ξέρεις λιγότερο.',
        en: 'The plan from work is usually the cover you use the most and know the least about.',
    },
    shortDescription: {
        el: 'Πρόγραμμα που συνάπτει ο εργοδότης για το προσωπικό: όρια ανά παροχή, συμμετοχές, ένταξη εξαρτώμενων μελών και τι ισχύει την ημέρα που φεύγεις από την εταιρεία — από το δικό σου πιστοποιητικό ασφάλισης.',
    ...
    whyItMatters: [
        {
            el: 'Τους όρους τους διαπραγματεύτηκε ο εργοδότης, όχι εσύ. Το πρόγραμμα ενδέχεται να αναδιαμορφωθεί ή να διακοπεί σε κάθε ανανέωση του εταιρικού συμβολαίου, χωρίς να ερωτηθείς.',
        ...
        {
            el: 'Αν στηριχθείς αποκλειστικά στο ομαδικό και ζητήσεις ατομικό αργότερα, η ασφαλισιμότητά σου θα κριθεί τότε — με την ηλικία και το ιστορικό υγείας που θα έχεις εκείνη τη στιγμή, όχι τα σημερινά.',
    ...
    whatWeAnalyze: [
        {
            el: 'Με βάση το έγγραφο που ανέβασες: ετήσιο όριο, συμμετοχή ή απαλλαγή ανά περιστατικό, θέση νοσηλείας και στοιχεία συντονιστικού κέντρου, όπου αναγράφονται.',
    ...
    howToUseBetter: [
        {
            el: 'Ζήτησε από το HR ολόκληρο το βιβλίο όρων, όχι μόνο την κάρτα. Η κάρτα δείχνει το δίκτυο· οι όροι δείχνουν τα όρια και τις εξαιρέσεις.',
        ...
        {
            el: 'Πριν αλλάξεις εργασία, ρώτησε γραπτώς μέχρι ποια ημερομηνία ισχύει η κάλυψη και αν προβλέπεται μετατροπή σε ατομικό συμβόλαιο.',
        ...
        {
            el: 'Αν σκέφτεσαι να διακόψεις ένα ατομικό πρόγραμμα επειδή «το καλύπτει η δουλειά», κράτα υπόψη ότι το ατομικό είναι εκείνο που σε ακολουθεί όταν αλλάξει η δουλειά.',
        ...
        {
            el: 'Δήλωσε γέννηση, γάμο ή σύμφωνο συμβίωσης στο HR μέσα στην προθεσμία ένταξης — τα παράθυρα για εξαρτώμενα μέλη είναι σύντομα.',
    ...
    commonGaps: [
        ...
        },
        {
            ...
            description: {
                el: 'Η ένταξη συζύγου και παιδιών σπάνια είναι αυτόματη. Αν δεν έγινε δήλωση στην προθεσμία, ενδέχεται να καλύπτεσαι μόνο εσύ.',
        ...
        },
        {
            ...
            description: {
                el: 'Εκτός δικτύου η συμμετοχή σου συνήθως ανεβαίνει σημαντικά, ακόμη κι όταν η ίδια παροχή καλύπτεται κανονικά.',
    ...
    recommendedActions: [
        {
            ...
            label: { el: 'Δες τα όρια ανά κατηγορία παροχής', en: 'See the limits per benefit category' },
            href: null,
            ctaType: 'askAi',
            question: {
        ...
        },
        {
            ...
            label: { el: 'Έλεγξε τι γίνεται αν φύγεις από την εταιρεία', en: 'Check what happens if you leave the company' },
            href: null,
            ctaType: 'askAi',
            question: {
        ...
        },
        {
            ...
            label: { el: 'Δες αν καλύπτονται σύζυγος και παιδιά', en: 'See whether spouse and children are covered' },
            href: null,
            ctaType: 'askAi',
            question: {
        ...
        },
        {
            ...
            label: { el: 'Δες πώς συνδυάζεται με το ατομικό σου πρόγραμμα', en: 'See how it combines with your individual plan' },
            href: '/coverage-insights',
            ctaType: 'review',
        },
        {
            id: 'group_health_ask_agent',
            label: { el: 'Ρώτησε τον σύμβουλό σου τι μένει ακάλυπτο', en: 'Ask your advisor what remains uncovered' },
            href: '/agent',
            ctaType: 'askAgent',
        },
    ],
    ...
    claimsSteps: [
        {
            el: 'Πριν από προγραμματισμένη νοσηλεία, επικοινώνησε με το συντονιστικό κέντρο του προγράμματος — συνήθως εκεί ανοίγει ο φάκελος και εκεί κρίνεται η απευθείας πληρωμή.',
        ...
        {
            el: 'Κράτα τον αριθμό ομαδικού συμβολαίου και τον κωδικό μέλους μαζί: το ομαδικό ταυτοποιείται από τον συνδυασμό των δύο, όχι από το όνομά σου.',
            en: 'Keep the group policy number and your member code together: a group plan is identified by the pair, not by your name.',
        },
        {
            el: 'Συγκέντρωσε πρωτότυπα παραστατικά και ιατρικές γνωματεύσεις — στα ομαδικά η αποζημίωση εξόδων γίνεται συχνά με υποβολή δικαιολογητικών εκ των υστέρων.',
        ...
        {
            el: 'Αν η εργασιακή σου σχέση λήγει όσο εκκρεμεί περιστατικό, ενημέρωσε αμέσως HR και ασφαλιστή — η εκκαθάριση εξαρτάται από την ημερομηνία του συμβάντος, όχι της πληρωμής.',
    ...
    renewalNote: {
        el: 'Το ομαδικό ανανεώνεται από την εταιρεία, όχι από εσένα. Μετά από κάθε ανανέωση αξίζει να δεις αν άλλαξαν όρια, δίκτυο ή συμμετοχές — οι αλλαγές ανακοινώνονται συχνά μόνο εσωτερικά.',
    ...
    emptyState: {
        headline: { el: 'Δεν έχεις προσθέσει ομαδικό πρόγραμμα υγείας', en: 'No group health plan added yet' },
        description: {
            el: 'Ανέβασε το πιστοποιητικό ασφάλισης που σου έδωσε η εταιρεία και δες τι φαίνεται να καλύπτει — και τι μένει στο ατομικό σου πρόγραμμα.',
