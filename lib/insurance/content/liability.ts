...
export const liabilityContent: BranchContent = {
    branchId: 'liability',
    tagline: {
        el: 'Η αστική ευθύνη δεν προστατεύει τα δικά σας πράγματα — προστατεύει την τσέπη σας όταν η ζημιά είναι σε άλλον.',
        en: 'Liability cover does not protect your own things — it protects your pocket when the damage is to someone else.',
    },
    shortDescription: {
        el: 'Σωματικές βλάβες και υλικές ζημιές σε τρίτους, ευθύνη ως ιδιοκτήτη σκύλου, ευθύνη ενοικιαστή απέναντι στον ιδιοκτήτη, πράξεις των παιδιών: το PolicyWallet διαβάζει πώς τα περιγράφει το δικό σας έγγραφο και στα εξηγεί με απλά λόγια.',
    ...
    whyItMatters: [
        {
            el: 'Πληρώνει σε άλλον, όχι σε εσάς: σωματικές βλάβες τρίτων και ζημιές σε ξένη περιουσία. Το δικό σας κινητό, έπιπλο ή αυτοκίνητο δεν μπαίνει ποτέ σε αυτόν τον λογαριασμό.',
        ...
        {
            el: 'Ως ιδιοκτήτης σκύλου ή ως γονέας ανηλίκου, ενδέχεται να ευθύνεσαι για πράξεις που δεν έκανες εσείς — η ευθύνη προκύπτει από την ιδιότητα, όχι από την πρόθεση.',
        ...
        {
            el: 'Ως ενοικιαστής, μια ζημιά που ξεκινά από το μίσθιο (νερά, φωτιά) φτάνει στον ιδιοκτήτη και στους γείτονες. Η ασφάλιση του κτιρίου καλύπτει τον ιδιοκτήτη — απέναντί του απαντά η δική σας ευθύνη.',
    ...
    whatWeAnalyze: [
        {
            el: 'Η αστική ευθύνη δεν έχει τυποποιημένη δομή στα ασφαλιστήρια, οπότε δουλεύουμε πάνω στο ελεύθερο κείμενο του εγγράφου που ανεβάσατε: τις καλύψεις και τις εξαιρέσεις όπως ακριβώς είναι διατυπωμένες.',
        ...
        {
            el: 'Ποιος περιγράφεται ως ασφαλισμένος — μόνο εσείς ή και τα μέλη του νοικοκυριού — και ποιες ιδιότητες αναφέρονται ρητά (κατοικίδιο, μίσθωση, ανήλικα τέκνα).',
    ...
    howToUseBetter: [
        ...
        {
            el: 'Αν έχετε σκύλο, δείτε αν αναφέρεται ρητά και με ποιες προϋποθέσεις (λουρί, φίμωτρο, δηλωμένη ράτσα) — οι προϋποθέσεις είναι που κρίνουν την απαίτηση.',
        ...
        {
            el: 'Αν μένεις με ενοίκιο, κρατήστε φωτογραφίες της κατάστασης του ακινήτου κατά την παράδοση των κλειδιών — είναι το σημείο αναφοράς σε κάθε μελλοντική διαφωνία.',
    ...
    commonGaps: [
        ...
        },
        {
            ...
            description: {
                el: 'Αν εργάζεσαι ως ελεύθερος επαγγελματίας, η ιδιωτική αστική ευθύνη συνήθως εξαιρεί ρητά ό,τι σχετίζεται με το επάγγελμά σας.',
    ...
    recommendedActions: [
        {
            ...
            label: { el: 'Δείτε αν έχετε ήδη αστική ευθύνη προς τρίτους', en: 'See if you already have third-party liability' },
            href: null,
            ctaType: 'askAi',
            question: {
        ...
        },
        {
            ...
            label: { el: 'Ελέγξτε ποιοι του σπιτιού καλύπτονται', en: 'Check who in the household is covered' },
            href: null,
            ctaType: 'askAi',
            question: {
        ...
        },
        {
            ...
            label: { el: 'Δείτε τι ισχύει για ζημιά από το κατοικίδιο', en: 'See what applies for damage caused by your pet' },
            href: null,
            ctaType: 'askAi',
            question: {
        ...
        },
        {
            ...
            label: { el: 'Ρωτήστε τον σύμβουλό σας για τα όρια ευθύνης', en: 'Ask your advisor about the liability limits' },
            href: '/agent',
            ctaType: 'askAgent',
        },
    ],
    ...
    claimsSteps: [
        {
            el: 'Μην αναγνωρίσετε ευθύνη και μη συμφωνήσετε ποσό επί τόπου — η αναγνώριση πριν την εξέταση της υπόθεσης ενδέχεται να επηρεάσει την αποζημίωση.',
            en: 'Do not admit liability or agree an amount on the spot — admitting before the case is assessed can affect the settlement.',
        },
        {
            el: 'Κρατήστε στοιχεία του τρίτου και τυχόν μαρτύρων, και φωτογραφίστε τη ζημιά όπως βρέθηκε.',
            en: 'Take the third party’s details and those of any witnesses, and photograph the damage as found.',
        },
        {
            el: 'Ενημερώστε τον ασφαλιστή σας αμέσως μόλις μάθεις για την απαίτηση — ακόμη κι αν είναι προφορική και δεν έχει ποσό ακόμη.',
            en: 'Notify your insurer as soon as you learn of the claim — even if it is verbal and has no amount yet.',
        },
        {
            el: 'Αν λάβεις εξώδικο, αγωγή ή οποιοδήποτε δικόγραφο, προώθησέ το χωρίς καθυστέρηση — οι δικονομικές προθεσμίες τρέχουν ανεξάρτητα από την ασφάλισή σας.',
    ...
    renewalNote: {
        el: 'Πριν την ανανέωση, αξίζει ένας έλεγχος στο τι άλλαξε στη ζωή σας: νέο κατοικίδιο, νέα μίσθωση ή νέα δραστηριότητα αλλάζουν το πόσο εκτεθειμένος είστε απέναντι σε τρίτους.',
