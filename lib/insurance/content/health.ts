...
export const healthContent: BranchContent = {
    branchId: 'health',
    tagline: {
        el: 'Μάθε τι πληρώνεις εσύ και τι ο ασφαλιστής σου — πριν βρεθείς στο νοσοκομείο.',
        en: 'Know what you pay and what your insurer pays — before you are in hospital.',
    },
    shortDescription: {
        el: 'Νοσοκομειακή περίθαλψη, πρωτοβάθμια φροντίδα, απαλλαγές, συμμετοχές, αναμονές και εξαιρέσεις — εξηγημένα με απλά λόγια, από το δικό σου συμβόλαιο.',
    ...
    whyItMatters: [
        {
            el: 'Η απαλλαγή και η συμμετοχή καθορίζουν τι θα πληρώσεις εσύ σε μια νοσηλεία — δύο συμβόλαια με ίδιο ασφάλιστρο μπορεί να διαφέρουν χιλιάδες ευρώ στην πράξη.',
        ...
        {
            el: 'Οι αναμονές σημαίνουν ότι κάποιες παθήσεις δεν καλύπτονται τους πρώτους μήνες — καλό είναι να τις ξέρεις πριν τις χρειαστείς.',
            en: 'Waiting periods mean some conditions are not covered in the first months — better to know them before you need them.',
        },
        {
            el: 'Αν έχεις και ομαδικό (από τη δουλειά) και ατομικό πρόγραμμα, ο σωστός συνδυασμός τους μπορεί να μειώσει σημαντικά τη δική σου συμμετοχή.',
    ...
    whatWeAnalyze: [
        {
            el: 'Με βάση το έγγραφο που ανέβασες: όριο κάλυψης, απαλλαγή, ποσοστό συμμετοχής, θέση νοσηλείας και δίκτυο συμβεβλημένων νοσοκομείων.',
        ...
        {
            el: 'Παροχές που ίσως ξεχνάς ότι έχεις: προληπτικός έλεγχος (check-up), δεύτερη ιατρική γνώμη, διαγνωστικές εξετάσεις, παροχές ευεξίας.',
            en: 'Benefits you may forget you have: preventive check-up, second medical opinion, diagnostics, wellbeing perks.',
        },
    ],
    howToUseBetter: [
        {
            el: 'Χρησιμοποίησε τον δωρεάν προληπτικό έλεγχο αν το πρόγραμμά σου τον περιλαμβάνει — συνήθως ανανεώνεται κάθε χρόνο και χάνεται αν δεν τον κάνεις.',
            en: 'Use the free preventive check-up if your plan includes it — it usually resets yearly and is lost if unused.',
        },
        {
            el: 'Πριν από προγραμματισμένη νοσηλεία, ρώτησε αν το νοσοκομείο είναι συμβεβλημένο — η διαφορά στη συμμετοχή μπορεί να είναι μεγάλη.',
            en: 'Before a planned hospitalisation, ask whether the hospital is in-network — the difference in what you pay can be large.',
        },
        {
            el: 'Αν έχεις ομαδικό πρόγραμμα, δες πρώτα τι καλύπτει εκείνο και μετά τι συμπληρώνει το ατομικό — με αυτή τη σειρά.',
    ...
    commonGaps: [
        ...
        },
        {
            ...
            title: { el: 'Αναμονές που δεν έχεις υπόψη', en: 'Waiting periods you may not know' },
            description: {
                el: 'Ορισμένες καλύψεις ενεργοποιούνται μήνες μετά την έναρξη — με βάση το έγγραφο, δες ποιες αναμονές ισχύουν ακόμη.',
    ...
    recommendedActions: [
        {
            id: 'health_check_oop',
            label: { el: 'Δες τι πληρώνεις εσύ σε νοσηλεία', en: 'See what you pay in a hospitalisation' },
            href: null,
            ctaType: 'askAi',
        ...
        },
        {
            ...
            label: { el: 'Έλεγξε αν το ομαδικό σου αρκεί', en: 'Check whether your group plan is enough' },
            href: '/coverage-insights',
            ctaType: 'review',
        },
        {
            id: 'health_check_waits',
            label: { el: 'Βρες πιθανές αναμονές και εξαιρέσεις', en: 'Find possible waits and exclusions' },
            href: null,
            ctaType: 'askAi',
        ...
        {
            id: 'health_use_perks',
            label: { el: 'Δες ποιες παροχές μπορείς να χρησιμοποιήσεις τώρα', en: 'See which benefits you can use now' },
            href: null,
            ctaType: 'askAi',
        ...
        {
            id: 'health_ask_agent',
            label: { el: 'Ρώτησε τον σύμβουλό σου για συμπληρωματική κάλυψη', en: 'Ask your advisor about supplementary cover' },
            href: '/agent',
            ctaType: 'askAgent',
        },
        {
    ...
    claimsSteps: [
        {
            el: 'Σε έκτακτη νοσηλεία, ενημέρωσε το συντονιστικό κέντρο του ασφαλιστή το συντομότερο — συνήθως υπάρχει 24ωρη γραμμή στο συμβόλαιο.',
            en: 'In an emergency admission, notify the insurer’s coordination centre promptly — there is usually a 24h line on the policy.',
        },
        {
            el: 'Για προγραμματισμένη νοσηλεία, ζήτησε προέγκριση πριν μπεις — αποφεύγεις εκπλήξεις στη συμμετοχή.',
            en: 'For a planned admission, get pre-approval before going in — it avoids surprises in your share.',
        },
        {
            el: 'Κράτα όλες τις γνωματεύσεις, τα παραπεμπτικά και τις αποδείξεις — ζητούνται σχεδόν πάντα στον φάκελο.',
            en: 'Keep all medical reports, referrals and receipts — they are almost always required in the file.',
        },
    ],
    renewalNote: {
        el: 'Στην ανανέωση, πρόσεξε αλλαγές σε απαλλαγή, συμμετοχή και όρια — και ρώτησε αν οι αναμονές που έχεις ήδη «χτίσει» μεταφέρονται.',
    ...
    emptyState: {
        headline: { el: 'Δεν έχεις προσθέσει συμβόλαιο υγείας', en: 'No health policy added yet' },
        description: {
            el: 'Ανέβασε το πρόγραμμα υγείας σου (ή το ομαδικό της δουλειάς) και δες τι πληρώνεις εσύ, τι αναμονές ισχύουν και ποιες παροχές έχεις.',
