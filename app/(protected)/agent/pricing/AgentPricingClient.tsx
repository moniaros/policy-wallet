                        ...
                        return (
                            <div
                                ...
                                className={`relative rounded-2xl border p-6 flex flex-col ${
                                    isCurrent
                                        ? "border-primary/60 bg-white dark:bg-stone-900 ring-2 ring-primary/30"
                                        : plan.popular
                            ...
                            >
                                ...
                                {isCurrent && (
                                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-stone-900 dark:bg-white text-white dark:text-stone-900 text-[10px] font-black uppercase tracking-widest px-4 py-1 rounded-full">
                                        {t.currentPlan}
                                    </div>
                                )}
