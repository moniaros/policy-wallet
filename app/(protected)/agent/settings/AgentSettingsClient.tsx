...
export function AgentSettingsClient({ initialAgencyName, initialLicenseNumber, verificationStatus }: Props) {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12">
            <div className="mb-10">
                <h1 className="text-3xl font-black text-stone-900 dark:text-white mb-2 uppercase tracking-tight">{roleCopy.agentSettings.title}</h1>
                <p className="text-stone-500 font-medium">{roleCopy.agentSettings.subtitle}</p>
            </div>
                ...
                <div className="md:col-span-2 space-y-6">
                    ...
                    <div className="bg-white dark:bg-stone-900 rounded-3xl p-8 border border-stone-200 dark:border-stone-800 shadow-sm space-y-8">
                        <div className="space-y-6">
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-stone-400 uppercase tracking-widest ml-1">{roleCopy.agentSettings.agencyName}</label>
                                <input
                                    type="text"
                                    value={agencyName}
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-stone-400 uppercase tracking-widest ml-1">{roleCopy.agentSettings.licenseNumber}</label>
                                <input
                                    type="text"
                                    value={licenseNumber}
                    ...
                    <div className="bg-rose-50/50 dark:bg-rose-900/10 rounded-3xl p-8 border border-rose-100 dark:border-rose-900/30">
                        ...
                        <p className="text-xs text-rose-700/70 dark:text-rose-400/70 mb-6 font-medium">{roleCopy.agentSettings.dangerDescription}</p>
