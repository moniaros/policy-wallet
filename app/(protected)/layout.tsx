...
import { Wallet, Shield, PieChart, Bell, LayoutDashboard, Users, Lightbulb, HeartPulse, Settings, Building2, Gavel, ShieldAlert, ReceiptText, ClipboardList, Activity, RefreshCw, Euro, UsersRound, FileQuestion, Flag, Handshake, FileText, Inbox, Coins, Zap, LogOut, UserRound } from 'lucide-react'
    ...
    if (currentRole === "policyholder") {
        ...
        navigation.push({
            ...
            items: [
                ...
                { label: t.nav.wellness, href: "/wellness", icon: <HeartPulse className="w-5 h-5" /> },
            ]
        })
        navigation.push({
