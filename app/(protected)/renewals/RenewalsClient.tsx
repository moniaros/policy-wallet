                ...
                {outcomeModal && (
                    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                        <div ref={renewDialogRef} role="dialog" aria-modal="true" aria-labelledby={renewTitleId} tabIndex={-1} className="bg-white dark:bg-neutral-900 rounded-2xl shadow-2xl max-w-md w-full p-6 space-y-5">
                            ...
                            <div>
                                <label className="text-kicker font-black text-neutral-400 uppercase tracking-widest">{t.notes}</label>
                                <textarea
                                    value={outcomeNotes}
...
function StatCard({
    ...
    return (
        <div className="pw-card pw-pad-tight">
            ...
            <p className="text-kicker font-bold text-neutral-400 uppercase tracking-widest mt-0.5">{label}</p>
        </div>
    )
}
