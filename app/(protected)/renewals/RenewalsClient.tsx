...
export function RenewalsClient({ initialRenewals, stats }: Props) {
    ...
    const getStatusBadge = (status: string, daysLeft: number) => {
        if (status === "completed") return (
            <span className="inline-flex items-center gap-1 text-[10px] font-black uppercase tracking-widest text-emerald-700 bg-emerald-50 dark:text-emerald-400 dark:bg-emerald-900/20 px-2.5 py-1 rounded-full">
                    ...
                    <div className="ml-auto flex items-center gap-2">
                        ...
                        {selectedIds.size > 0 && (
                            <button
                                ...
                                disabled={isSending}
                                className="inline-flex items-center gap-1.5 px-4 py-2 bg-teal-600 text-white text-xs font-bold rounded-lg hover:bg-teal-700 transition-colors disabled:opacity-50"
                            >
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl max-w-md w-full p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={2}
                                    className="w-full mt-1 bg-slate-50 dark:bg-slate-800 border-none rounded-xl px-4 py-3 text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:ring-2 focus:ring-teal-500 outline-none resize-none"
                                />
                            </div>
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    disabled={isSaving}
                                    className="flex-1 py-2.5 rounded-xl text-sm font-bold bg-teal-600 text-white hover:bg-teal-700 transition-colors disabled:opacity-50"
                                >
                                    {isSaving ? "..." : t.save}
                                </button>
                            </div>
