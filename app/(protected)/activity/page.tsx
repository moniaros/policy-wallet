    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12">
            ...
            <p className="text-stone-600 dark:text-stone-400">
                {t.activity?.subtitle || 'Tracking all recent interactions, document uploads, and policy changes across your customer base.'}
            </p>
            <div className="mt-8 flex flex-col gap-4">
                <div className="p-10 border-2 border-dashed border-stone-200 dark:border-stone-700 rounded-3xl text-center">
                    ...
                    <h3 className="text-lg font-bold text-stone-700 dark:text-stone-300">
                        {t.activity?.noActivity || 'Quiet for now'}
                    </h3>
                    <p className="text-sm text-stone-500">
                        {t.activity?.noActivityDesc || 'Activity will appear here as your customers interact with their wallets.'}
                    </p>
                </div>
            </div>
        </div>
