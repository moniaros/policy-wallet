                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 bg-white dark:bg-stone-800 rounded-3xl p-6 sm:p-8 border border-stone-200 dark:border-stone-700 shadow-sm">
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                <h2 className="text-sm font-black text-stone-900 dark:text-white uppercase tracking-widest">{heading(t.wallet.aiPolicyInsights)}</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-6">
                                <div>
                                    <p className="text-[10px] font-black text-stone-400 uppercase tracking-widest mb-2">{heading(t.wallet.verificationOverview)}</p>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="p-3 bg-stone-50 dark:bg-stone-900/30 rounded-xl">
                                        <p className="text-[10px] font-black text-stone-400 uppercase tracking-widest mb-1">{heading(t.wallet.contractInsurer)}</p>
                                        <p className="text-xs font-bold text-stone-900 dark:text-white truncate">
                                            {String((acordData as any).policy?.insurer || '')}
                                        </p>
                                    </div>
                                    <div className="p-3 bg-teal-50 dark:bg-teal-900/20 rounded-xl">
                                        <p className="text-[10px] font-black text-stone-400 uppercase tracking-widest mb-1">{heading(t.wallet.premiumFound)}</p>
                            ...
                            <div className="space-y-3">
                                <p className="text-[10px] font-black text-stone-400 uppercase tracking-widest mb-2">{heading(t.wallet.structuredCoverages)}</p>
