...
import { askPolicyQuestion } from "../actions"
                            ...
                            <div className="space-y-2">
                                {suggestedQuestions.map((q, idx) => (
                                    <button
                                        ...
                                        className="w-full text-left px-4 py-3 bg-slate-50 dark:bg-slate-800 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-xl text-sm text-slate-700 dark:text-slate-300 transition-colors border border-slate-200 dark:border-slate-700 hover:border-indigo-300 dark:hover:border-indigo-700"
                                    >
