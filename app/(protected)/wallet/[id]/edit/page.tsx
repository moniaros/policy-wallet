    ...
    return (
        <div className="pb-20">
            ...
            <div className="flex items-center gap-3 border-b border-border-hair px-4 py-3">
                <Link href={safeReturnTo ?? `/wallet/${id}`} aria-label={t.common.back} className="-ml-2 grid h-11 w-11 shrink-0 place-items-center rounded-full transition-colors hover:bg-surface-sunken focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-border-focus">
