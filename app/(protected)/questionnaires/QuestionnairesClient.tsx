            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
                ...
                <div className="flex gap-1 mb-8 bg-slate-100 dark:bg-slate-800 rounded-xl p-1 w-fit">
                    <button
                        ...
                        className={`px-5 py-2.5 rounded-lg text-xs font-black uppercase tracking-widest transition-all ${tab === "templates" ? "bg-white dark:bg-slate-700 text-slate-900 dark:text-white shadow-sm" : "text-slate-500 hover:text-slate-700"}`}
                    >
                    ...
                    <button
                        onClick={() => setTab("sent")}
                        className={`px-5 py-2.5 rounded-lg text-xs font-black uppercase tracking-widest transition-all ${tab === "sent" ? "bg-white dark:bg-slate-700 text-slate-900 dark:text-white shadow-sm" : "text-slate-500 hover:text-slate-700"}`}
                    >
        ...
        <div className="fixed inset-0 z-50 flex items-start justify-center p-4 pt-16 overflow-y-auto">
            ...
            >
                <div className="p-8">
                    ...
                    <button
                        onClick={addQuestion}
                        className="w-full py-3 rounded-xl border-2 border-dashed border-slate-200 dark:border-slate-700 text-sm font-bold text-slate-400 hover:text-slate-600 hover:border-slate-300 transition-all flex items-center justify-center gap-2"
                    >
                        <Plus className="w-4 h-4" />
                        {t.addQuestion}
                    </button>
                    ...
                    {error && (
                        <p className="mt-4 text-xs text-red-600 font-bold flex items-center gap-1">
                    ...
                    >
                        <div className="p-8">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <button onClick={() => setAnalysisData(null)} className="p-2 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-400">
                                    <X className="w-5 h-5" />
                                </button>
                            </div>
