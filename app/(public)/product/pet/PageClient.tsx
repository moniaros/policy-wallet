                ...
                <div className="mx-auto max-w-page grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-last md:order-first bg-white dark:bg-slate-900 p-8 rounded-xl border border-[#E2E8F0] dark:border-slate-800 shadow-[0_20px_40px_rgba(0,0,0,0.04)]">
                        <div className="flex items-center justify-between mb-8 border-b border-gray-100 dark:border-white/10 pb-4">
                            <div>
                                <h3 className="text-body font-bold text-[#0F172A] dark:text-white uppercase tracking-wider">Golden Retriever</h3>
                        ...
                        <div className="space-y-4">
                            <div className="p-4 bg-[#F0FDF4] dark:bg-[#29685B]/15 rounded-lg flex justify-between items-center border border-[#29685B]/20">
                                <div className="font-medium text-[#166534] dark:text-[#A7F3D0] text-sm">Leishmania Covered</div>
                            ...
                            <div className="p-4 bg-rose-50 dark:bg-rose-900/20 rounded-lg flex justify-between border border-rose-100 dark:border-rose-800/40">
                                <div>
                                    ...
                                    <p className="text-xs text-rose-700 dark:text-rose-200 mt-1">- Hip Dysplasia (Pre-existing)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-6">
                            <li className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="text-lead font-semibold text-[#0F172A] dark:text-white">{t("Κάλυψη Καλαζάρ (Leishmania)", "Mediterranean Vector Coverage")}</h4>
                                    <p className="text-[#475569] dark:text-slate-300">{t("Αυτόματος έλεγχος αν η ασφάλεια σας περιλαμβάνει την κρίσιμη θεραπεία για τις μεσογειακές νόσους.", "Automated verification targeting explicitly expensive vector diseases like Leishmania.")}</p>
                                </div>
                            </li>
                            <li className="flex gap-4">
                                <div className="flex-shrink-0 mt-1"><CheckCircle2 className="w-6 h-6 text-[#29685B] dark:text-[#A7F3D0]" /></div>
                                <div>
                                    <h4 className="text-lead font-semibold text-[#0F172A] dark:text-white">{t("Εξαιρέσεις & Radar Charts", "Condition Radar Visualisation")}</h4>
                                    <p className="text-[#475569] dark:text-slate-300">{t("Δείτε συγκεντρωτικά ποιες γενετικές ή προ-υπάρχουσες εξαιρέσεις βαραίνουν το συμβόλαιο σας.", "Aggregated visual representations of genetic or pre-existing exclusions mapped against your specific breed.")}</p>
                                </div>
                            </li>
                        </ul>
                    </div>
