                    ...
                    <div>
                        ...
                        <ul className="space-y-6">
                            <li className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="text-lead font-semibold text-[#0F172A]">{t("Έλεγχος Τρέχουσας Αξίας", "Market Value Meters")}</h4>
                            ...
                            <li className="flex gap-4">
                                <div className="flex-shrink-0 mt-1"><CheckCircle2 className="w-6 h-6 text-[#29685B]" /></div>
                                <div>
                                    <h4 className="text-lead font-semibold text-[#0F172A]">{t("Κενά Οδικής Βοήθειας", "Roadside Gap Analysis")}</h4>
                    ...
                    <div className="bg-white p-8 rounded-[12px] border border-[#E2E8F0] shadow-[0_20px_40px_rgba(0,0,0,0.04)]">
                        <div className="flex items-center justify-between mb-8 border-b border-gray-100 pb-4">
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-body-sm text-[#166534] font-medium">Fully Covered</p>
                            </div>
                        </div>
                ...
                <div className="mx-auto max-w-page">
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        <div className="rounded-[16px] border border-[#E2E8F0] bg-white p-7">
                            ...
                            <h3 className="text-title font-semibold text-[#0F172A] mb-3">{t("Μοτοσικλέτα", "Motorbike")}</h3>
                        ...
                        <div className="rounded-[16px] border border-[#E2E8F0] bg-white p-7">
                            ...
                            <h3 className="text-title font-semibold text-[#0F172A] mb-3">{t("Οδική Βοήθεια", "Roadside Assistance")}</h3>
                            <p className="text-body leading-relaxed text-[#475569]">
