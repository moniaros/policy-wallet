        ...
        <LoBPageShell activeNav="product">
            ...
            <section className="px-6 lg:px-12">
                <div className="mx-auto max-w-[900px] text-center">
                    <span className="inline-flex bg-[#E6DDF2] text-[#1A1A1A] px-3 py-1 rounded-full text-[12px] font-semibold tracking-wider uppercase mb-6">
                    ...
                    <div>
                        ...
                        <ul className="space-y-6">
                            <li className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="text-[18px] font-semibold text-[#1A1A1A]">{t("Κάλυψη Ransomware", "Ransomware Validation")}</h4>
                            ...
                            <li className="flex gap-4">
                                <div className="flex-shrink-0 mt-1"><CheckCircle2 className="w-6 h-6 text-[#29685B]" /></div>
                                <div>
                                    <h4 className="text-[18px] font-semibold text-[#1A1A1A]">{t("Απώλεια κερδών (BI)", "Business Interruption (BI)")}</h4>
