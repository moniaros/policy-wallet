                    ...
                    <div>
                        ...
                        <ul className="space-y-6">
                            <li className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="text-[18px] font-medium text-[#1A1A1A]">{t("Εφάπαξ ή σύνταξη;", "Lump sum or annuity?")}</h4>
                            ...
                            <li className="flex gap-4">
                                <div className="flex-shrink-0 mt-1"><CheckCircle2 className="w-6 h-6 text-[#29685B]" /></div>
                                <div>
                                    <h4 className="text-[18px] font-medium text-[#1A1A1A]">{t("Όροι εξαγοράς στο φως", "Surrender terms in the open")}</h4>
                            ...
                            <li className="flex gap-4">
                                <div className="flex-shrink-0 mt-1"><CheckCircle2 className="w-6 h-6 text-[#29685B]" /></div>
                                <div>
                                    <h4 className="text-[18px] font-medium text-[#1A1A1A]">{t("Εγγυημένο ή επενδυτικό σκέλος", "Guaranteed vs investment component")}</h4>
