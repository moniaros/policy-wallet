                ...
                <div className="mx-auto max-w-[1240px]">
                    ...
                    <div className="grid gap-6 md:grid-cols-3">
                        <div className="rounded-[16px] border border-[#E2E8F0] bg-white p-7">
                            ...
                            <h3 className="text-[20px] font-semibold text-[#1A1A1A] mb-3">{t("Ιατρικά έκτακτα & Σένγκεν", "Emergency medical & Schengen")}</h3>
                        ...
                        <div className="rounded-[16px] border border-[#E2E8F0] bg-white p-7">
                            ...
                            <h3 className="text-[20px] font-semibold text-[#1A1A1A] mb-3">{t("Ακύρωση ταξιδιού", "Trip cancellation")}</h3>
                            <p className="text-[14px] leading-relaxed text-[#475569]">
                        ...
                        <div className="rounded-[16px] border border-[#E2E8F0] bg-white p-7">
                            ...
                            <h3 className="text-[20px] font-semibold text-[#1A1A1A] mb-3">{t("Αποσκευές & επαναπατρισμός", "Luggage & repatriation")}</h3>
                            <p className="text-[14px] leading-relaxed text-[#475569]">
