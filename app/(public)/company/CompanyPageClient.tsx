        ...
        <LoBPageShell activeNav="company">
            <main className="pb-24">
                ...
                <section className="mx-auto mb-20 max-w-4xl px-6 lg:px-12">
                    <div className="rounded-[20px] border border-[#DCEBDA] bg-[#F4F9F3] p-8 md:p-10">
                        <h2 className="mb-4 text-[26px] font-medium tracking-tight text-[#0F172A]">
                            {t("Τι είναι το PolicyWallet;", "What is PolicyWallet?")}
                        </h2>
                        <p className="mb-6 text-[17px] leading-relaxed text-[#334155]">
                ...
                <section className="mx-auto mb-24 max-w-4xl px-6 lg:px-12">
                    ...
                    <div className="space-y-5 text-[17px] leading-[1.75] text-[#334155]">
                        <p>
                            {t(
