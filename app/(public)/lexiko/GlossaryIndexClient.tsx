    ...
    return (
        <LoBPageShell activeNav="none">
            <section className="mx-auto max-w-[860px] px-6 pb-16 text-center md:px-12">
                ...
                <h1 className="mb-6 text-[40px] font-semibold leading-[1.05] tracking-[-0.03em] text-[#0F172A] md:text-[56px] dark:text-white">
                    {t(
                        "Οι ασφαλιστικοί όροι σε απλά ελληνικά",
                        "Insurance terms in plain language"
                    )}
                </h1>
                <p className="mx-auto max-w-[620px] text-[18px] leading-relaxed text-[#475569] dark:text-slate-400">
                    {t(
            ...
            <section className="mx-auto max-w-[1040px] px-6 pb-24 md:px-12">
                <div className="grid gap-5 sm:grid-cols-2">
                    {glossaryTerms.map((entry) => (
                        ...
                        >
                            <div className="mb-3 inline-flex items-center gap-1.5 text-[13px] text-[#64748B]">
                                <BookOpen className="h-4 w-4 text-[#29685B]" />
                                {t("Ορισμός", "Definition")}
                            </div>
                            <h2 className="mb-2 text-[20px] font-semibold leading-snug tracking-tight text-[#0F172A] transition-colors duration-150 group-hover:text-[#29685B] dark:text-white">
                                {entry.term[lang]}
                            </h2>
                            <p className="mb-4 line-clamp-3 text-[15px] leading-relaxed text-[#475569] dark:text-slate-400">
