    ...
    return (
        <LoBPageShell activeNav="none" locale={language}>
            <section className="mx-auto max-w-[860px] px-6 pb-16 text-center md:px-12">
                ...
                <p className="mx-auto max-w-[620px] text-lead leading-relaxed text-[#475569] dark:text-slate-500">
                    {t(
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                    {glossaryTerms.map((entry) => (
                        ...
                        >
                            ...
                            <p className="mb-4 line-clamp-3 text-body leading-relaxed text-[#475569] dark:text-slate-500">
