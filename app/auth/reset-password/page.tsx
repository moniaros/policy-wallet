                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                />
                                <button type="button" onClick={() => setShowPassword((prev) => !prev)} className="absolute right-2 top-2.5 rounded-md p-1.5 text-slate-500 transition hover:bg-slate-100 dark:hover:bg-white/10" aria-label={showPassword ? "Hide password" : "Show password"}>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                />
                                <button type="button" onClick={() => setShowConfirmPassword((prev) => !prev)} className="absolute right-2 top-2.5 rounded-md p-1.5 text-slate-500 transition hover:bg-slate-100 dark:hover:bg-white/10" aria-label={showConfirmPassword ? "Hide password" : "Show password"}>
