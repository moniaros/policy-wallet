    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-slate-900 px-4 py-12 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
                ...
                <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-slate-500/10 blur-[120px] animate-pulse-slow delay-700" />
            </div>
            ...
            <div className="w-full max-w-md bg-slate-900/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700/50 p-8 sm:p-10 relative z-10 animate-in fade-in zoom-in duration-500 hover:shadow-red-500/5 transition-all text-center">
                ...
                <Link
                    href="/auth/signin"
                    className="block w-full rounded-xl bg-gradient-to-r from-slate-600 to-slate-700 hover:from-slate-500 hover:to-slate-600 px-4 py-3.5 text-sm font-bold text-white shadow-lg shadow-slate-500/20 transition-all hover:-translate-y-0.5"
                >
                    Return to Sign In
                </Link>
            </div>
