...
| `HealthRiskAssessment` | Consent — Art. 6(1)(a) | policyholder | For as long as the account exists; removed on erasure | Deleted |
...
| `AgentReviewRevision` | Consent — Art. 6(1)(a) | policyholder, agent | For as long as the account exists; removed on erasure | Deleted |
...
| `PartnerReferral` | Performance of a contract — Art. 6(1)(b) | policyholder | For as long as the account exists; removed on erasure | Deleted |
...
| `WalletMembership` | Consent — Art. 6(1)(a) | policyholder | For as long as the account exists; removed on erasure | Deleted |
