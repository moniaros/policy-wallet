...
| 8 | total annual premium | **συνολικό ετήσιο ασφάλιστρο** | «Ασφαλιστικό αποτύπωμα» | Coinages get retired, not explained. One live use (`status.totalPremium`). («δακτυλικό αποτύπωμα» = fingerprint, a different word — allowed.) |
