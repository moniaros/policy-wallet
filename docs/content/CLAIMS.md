...
| C16 | preventive calendar intervals (πίεση κάθε έτος, λιπίδια 40+/5 έτη, γλυκόζη 45+/3 έτη, τεστ Παπ 21–65/3 έτη, μαστογραφία 50–69/2 έτη, παχύ έντερο 50–74/2 έτη) | `/wellness` (`lib/wellness/preventive.ts`) | general adult preventive guidance, labelled «γενική οδηγία» with «επιβεβαιώστε με τον γιατρό σας» on every card; no coverage claim is attached to any interval | **RETIRED 2026-09-24** (prevention brief: no individual screening schedule from age or sex; the calendar no longer renders, guard `wellness-no-individual-screening-schedule`). Was: sourced 2026-09-23 — cite the national screening programme by name when its page is added to `guide.sources[]` |
| C17 | daily habit nudges (e.g. «Περπατήστε 15 λεπτά σήμερα», «Πιείτε ένα ποτήρι νερό») | `/wellness`, home, opt-in push (`wellness.nudges.*`) | general everyday habits, the same for everyone, no medical claim, labelled «Γενικές ιδέες για την καθημερινότητα, όχι ιατρική συμβουλή»; the only number is a duration the person can choose to follow | authored 2026-09-24, no external figure is quoted |
