...
| V2 | **CUT — confirmed against the primary.** The ΕΛΣΤΑΤ release itself (read 2026-08-30) says **nothing about IOBE**, so "abolished January 2025 / replaced the IOBE index" stays out of shippable copy entirely. |
| V3 | **RESOLVED — primary read, figures SHIPPED with their scopes.** ΕΛΣΤΑΤ DKT58, δελτίο τύπου 29.07.2026 (2024 values first published 26.06.2026), filename `A0903_DKT58_DT_AN_00_2024_01_F_GR.pdf`. Compiled under **ν. 5170/2025**; factors per **ΚΥΑ αρ. 74816 (ΦΕΚ Β΄ 5170/2025)** — the shared «5170» is a genuine law-number / ΦΕΚ-issue coincidence, both instruments real. **6,24% = the aggregate** (with age; 1,25% without); **long-term specifically 7,23% / 1,76%**; annually-renewed 5,36% / 0,79%. Copy names figure + contract type + age variant in the same sentence, never a bare percentage. |
