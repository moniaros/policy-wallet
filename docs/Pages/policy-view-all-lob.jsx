...
const POLICIES = {
  motor: {
    ...
    acordData:{
      vehicle:{ make:"Toyota", model:"Corolla", year:2019, plate:"ΑΑΑ-1234",
  ...
  health: {
    ...
    acordData:{
      health:{ annualLimit:30000, roomAndBoardLimit:250, outOfPocketMax:2000,
  ...
  home: {
    ...
    acordData:{
      property:{ address:"Πατησίων 45, Αθήνα 10434", squareMeters:92,
  ...
  life: {
    ...
    acordData:{
      lifeAndInvestment:{ deathBenefit:100000, cashValue:18740, guaranteedPortion:0.4,
  ...
  pet: {
    ...
    acordData:{
      pet:{ name:"Μπάμπης", species:"Dog", breed:"Golden Retriever", age:4,
  ...
  doctor: {
    ...
    acordData:{
      professional:{ speciality:"Παθολόγος", coverageLimit:500000,
  ...
  marine: {
    ...
    acordData:{
      marine:{ vesselName:"Αιγαίον", vesselType:"Sailing yacht", lengthM:11.5,
