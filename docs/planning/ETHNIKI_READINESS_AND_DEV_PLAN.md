...
>
> **☐ Απομένει — μόνο key-gated πλέον:** η ποιότητα εξαγωγής πραγματικού
> μοντέλου. Με κλειδί στο περιβάλλον, μία εντολή:
> `npx tsx scripts/verify-pipeline-live.ts <pdf>` — και σύγκριση του
> extraction block με τα golden του fixture. Δείγματα υπόλοιπων κλάδων:
> owner action #4, ψευδωνυμοποιημένα εξαρχής.
