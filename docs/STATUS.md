...
2. **PW-BRIDGE-01 L0** — the parity/interaction inventory (`docs/bridge/PARITY.md`, `INTERACTIONS.md`, the two-sided harness); halts for approval after L0. C1–C7 stay unstarted.
