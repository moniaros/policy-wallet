            ...
            <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6">
                ...
                >
                    ...
                    >
                        {tr("Ιστορικό", "History")}
                        {unreadCount > 0 && (
                            <span className="absolute -right-1 -top-1 grid h-5 min-w-5 place-items-center rounded-full bg-primary px-1 text-kicker font-bold text-primary-foreground">
                                {unreadCount}
                            </span>
                        )}
                    </button>
                                        ...
                                        <div
                                            ...
                                            className={`cursor-pointer rounded-2xl border p-4 shadow-sm transition ${
                                                isRead
                                                    ...
                                                    : "border-l-[3px] border-l-primary border-t-black/10 border-r-black/10 border-b-black/10 dark:border-b-white/15 bg-primary/5 dark:bg-primary/10"
                                            }`}
                                        >
