...
const steps: TourStep[] = [
    {
        ...
        title: { el: "Το πρώτο σας ασφαλιστήριο!", en: "Your First Policy!" },
        content: { el: "Εδώ βρίσκεται το νέο σας ασφαλιστήριο. Πατήστε για πλήρη στοιχεία, έγγραφα και AI ανάλυση.", en: "Here lies your newly added policy. Tap it to see full details, documents, and AI insights." },
        position: "bottom"
    },
    {
        targetId: "tour-fab",
        title: { el: "Προσθήκη ασφαλιστηρίων", en: "Add More Policies" },
        content: { el: "Χρησιμοποιήστε αυτό το κουμπί για να προσθέσετε ασφαλιστήρια — υποστηρίζει PDF, φωτογραφίες ή χειροκίνητη εισαγωγή.", en: "Use this button to add more policies anytime—supports PDF, photos, or manual entry." },
        position: "top-left"
    },
    {
        targetId: "tour-search",
        title: { el: "Αναζήτηση & Φίλτρα", en: "Find & Filter" },
        content: { el: "Βρείτε γρήγορα οποιοδήποτε ασφαλιστήριο με αναζήτηση ή φίλτρα κατηγορίας.", en: "Quickly find any policy by searching or filtering by category." },
        position: "bottom"
    }
]
            ...
            */}
            ...
            >
                <button
                    ...
                    className="absolute top-4 right-4 text-slate-500 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-200"
                >
                    <X className="w-4 h-4" />
                </button>
