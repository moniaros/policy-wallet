        ...
        <div className="max-w-7xl mx-auto py-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-8">
                    <div className="pw-card pw-pad-roomy relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <span className="text-kicker font-black uppercase tracking-widest text-muted-foreground">{t.billing.subscriptionStatus}</span>
                            </div>
                            ...
                            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
                                ...
                                <div className="text-right">
                                    ...
                                    <span className="text-kicker font-black uppercase tracking-widest text-muted-foreground">{t.billing.perMonth}</span>
                                </div>
                            </div>
                            ...
                            {currentSubscription.provider === "revenue_cat" ? (
                                <div className="mt-8 p-6 bg-primary-tint dark:bg-primary/15 rounded-3xl border border-primary/30 dark:border-primary/30">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-kicker font-medium text-primary dark:text-mint leading-relaxed">
                                ...
                                <div className="flex items-center gap-4 pt-8 border-t border-black/10 dark:border-white/15">
                                    <button
                                        ...
                                        className="px-5 py-2.5 bg-primary text-white dark:text-[#1A2420] rounded-xl text-kicker font-black uppercase tracking-wider hover:bg-primary-hover transition-all shadow-lg shadow-primary/20"
                                    >
                                    ...
                                    {onOpenPortal && (
                                        <button
                                            ...
                                            className="px-5 py-2.5 border border-black/15 dark:border-white/20 text-black/70 dark:text-white/75 rounded-xl text-kicker font-black uppercase tracking-wider hover:border-primary/40 hover:text-primary dark:hover:text-mint transition-all"
                                        >
                                    ...
                                    <button
                                        onClick={() => onCancel?.()}
                                        className="px-5 py-2.5 text-muted-foreground hover:text-red-500 rounded-xl text-kicker font-black uppercase tracking-wider transition-all"
                                    >
                                ...
                                currentSubscription.provider !== "revenue_cat" && (
                                    <div className="mt-6 flex flex-wrap items-center gap-x-4 gap-y-3 rounded-3xl border border-primary/25 bg-primary-tint p-5 dark:bg-primary/10">
                                        <div className="min-w-0 flex-1">
                                            ...
                                            <p className="mt-1 text-micro font-medium leading-relaxed text-black/60 dark:text-white/65">
                                                {pickCopy(BILLING_COPY.annualNudgeBody, language)}
                                            </p>
                                        </div>
                                        <button
                                            onClick={() => onSwitchToAnnual()}
                                            className="px-5 py-2.5 bg-primary text-white dark:text-[#1A2420] rounded-xl text-kicker font-black uppercase tracking-wider hover:bg-primary-hover transition-all"
                                        >
                    ...
                    <div className="pw-card overflow-hidden">
                        <div className="px-8 py-6 border-b border-black/10 dark:border-white/15 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="text-kicker font-black uppercase tracking-widest text-black dark:text-white">{t.billing.invoiceRecords}</h3>
                            </div>
                        </div>

                        {invoices.length === 0 ? (
                            <div className="p-20 text-center">
                                <p className="text-muted-foreground text-sm italic font-medium">{t.billing.noInvoices}</p>
                            </div>
                        ) : (
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    <thead className="bg-black/5 dark:bg-black">
                                        <tr>
                                            <th className="px-8 py-4 text-left text-kicker font-black text-muted-foreground uppercase tracking-wider">{t.billing.reference}</th>
                                            <th className="px-8 py-4 text-left text-kicker font-black text-muted-foreground uppercase tracking-wider">{t.billing.issueDate}</th>
                                            <th className="px-8 py-4 text-center text-kicker font-black text-muted-foreground uppercase tracking-wider">{t.billing.status}</th>
                                            <th className="px-8 py-4 text-right text-kicker font-black text-muted-foreground uppercase tracking-wider">{t.billing.amount}</th>
                                            <th className="px-8 py-4 text-right text-kicker font-black text-muted-foreground uppercase tracking-wider">{t.billing.action}</th>
                                        </tr>
                                    </thead>
                                                ...
                                                <tr key={invoice.invoice_id} className="hover:bg-black/5 dark:hover:bg-black/80 transition-all group">
                                                    ...
                                                    <td className="px-8 py-5 whitespace-nowrap text-right">
                                                        ...
                                                        {invoice.credits_applied && (
                                                            <div className="text-kicker font-bold text-primary dark:text-mint uppercase tracking-widest">-{formatPrice(invoice.credits_applied, invoice.currency)} {t.billing.applied}</div>
                                                        )}
                                                    </td>
                                                    <td className="px-8 py-5 whitespace-nowrap text-right">
                                                        {invoice.pdf_url && (
                                                            <button
                                                                ...
                                                                className="w-8 h-8 rounded-lg bg-black/5 dark:bg-black flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-white dark:hover:text-[#1A2420] transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                                                            >
                ...
                <div className="space-y-8">
                    <div className="pw-card pw-pad-roomy">
                        <div className="flex items-center justify-between mb-8">
                            <h3 className="text-kicker font-black uppercase tracking-widest text-black dark:text-white">{t.billing.paymentMethod}</h3>
                            {defaultPaymentMethod && (
                                <button
                                    onClick={() => (onUpdatePaymentMethod ? onUpdatePaymentMethod(defaultPaymentMethod.payment_method_id) : onOpenPortal?.())}
                                    className="text-kicker font-black uppercase tracking-widest text-primary dark:text-mint hover:underline rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                                >
                                    {t.billing.edit}
                                </button>
                            )}
                        ...
                        {defaultPaymentMethod ? (
                            <div className="relative group">
                                ...
                                <div className="relative flex items-center gap-5">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-kicker font-black text-muted-foreground uppercase tracking-widest mt-0.5">
                            ...
                            >
                                <div className="w-12 h-12 rounded-2xl bg-black/5 dark:bg-black flex items-center justify-center text-muted-foreground group-hover:bg-primary group-hover:text-white dark:group-hover:text-[#1A2420] transition-all mb-4">
                        ...
                        <div className="mt-10 p-6 bg-black/5 dark:bg-black rounded-3xl border border-black/10 dark:border-white/15">
                            <div className="flex gap-3">
                                ...
                                <p className="text-kicker font-medium text-muted-foreground leading-relaxed italic">
