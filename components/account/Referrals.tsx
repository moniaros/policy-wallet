                    ...
                    <div className="relative bg-white dark:bg-black border border-black/10 dark:border-white/15 rounded-[32px] p-8 shadow-sm h-full flex flex-col justify-between">
                        <div>
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest text-[#1FDC86] dark:text-[#1FDC86]">{t.referrals.growthNetwork}</span>
                            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-wrap gap-4 pt-4">
                                <button
                                    ...
                                    className="flex-1 flex items-center justify-center gap-3 px-5 py-3 bg-[#1FDC86] text-white rounded-xl text-[10px] font-black uppercase tracking-wider hover:bg-[#19b870] transition-all shadow-lg shadow-[#1FDC86]/25"
                                >
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-between">
                        <div>
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest text-[#7de8ba]">{t.referrals.creditBalance}</span>
                            </div>
                        ...
                        <div className="p-6 bg-white/10 backdrop-blur-md rounded-3xl border border-white/10">
                            <p className="text-[10px] font-black uppercase tracking-widest mb-3 text-[#7de8ba]">{t.referrals.valueProp}</p>
                                ...
                                return (
                                    <div key={referral.referral_id} className="px-8 py-5 hover:bg-black/5 dark:hover:bg-black/80 transition-all group">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <div className="text-sm font-black text-black dark:text-white mb-1 group-hover:text-[#1FDC86] transition-colors">
                                    ...
                                    {creditTransactions.map((transaction) => (
                                        <tr key={transaction.transaction_id} className="hover:bg-black/5 dark:hover:bg-black/80 transition-all">
                                            ...
                                            <td className="px-8 py-5 whitespace-nowrap text-right">
                                                <span className={`text-xs font-black ${transaction.amount > 0 ? "text-[#1FDC86] dark:text-[#1FDC86]" : "text-black/45 dark:text-white/60"}`}>
