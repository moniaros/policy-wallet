    ...
    return (
        <section id={id} className="px-6 py-20 lg:px-12">
            <div className="mx-auto max-w-page">
                    ...
                    {offers.map((offer) => (
                        <div key={offer.id} className="pw-card pw-pad">
                            <div className="mb-2 flex items-center justify-between gap-3">
                                <span className="text-xs font-semibold uppercase tracking-wide text-[#5B6A7A] dark:text-slate-400">
                                    {offer.vendorName}
                                </span>
                ...
                <p className="mt-6 text-center text-xs text-[#5B6A7A] dark:text-slate-400">
                    {t(
