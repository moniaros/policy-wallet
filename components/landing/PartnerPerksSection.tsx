        ...
        <section id={id} className="px-6 py-20 lg:px-12">
            <div className="mx-auto max-w-page">
                <div className="mb-10 text-center">
                    ...
                    <p className="mx-auto mt-3 max-w-2xl text-neutral-600 dark:text-slate-400">
                        {t(
                ...
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                    {offers.map((offer) => (
                        <div key={offer.id} className="pw-card pw-pad">
                            ...
                            <p className="mt-1.5 text-sm leading-relaxed text-neutral-600 dark:text-slate-400">
                                {offer.description[lang]}
                            </p>
                        </div>
                    ))}
                </div>
                <p className="mt-6 text-center text-xs text-muted-foreground dark:text-slate-400">
                    {t(
