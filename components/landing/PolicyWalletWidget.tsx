                ...
                <div className="p-5">
                    ...
                    >
                        ...
                        <Link
                            ...
                            className="inline-flex min-h-[24px] flex-shrink-0 items-center rounded-full bg-[#ECFDF5] dark:bg-[#29685B]/15 px-2.5 py-1 text-micro font-semibold text-[#29685B] dark:text-[#A7F3D0] hover:bg-[#D1FAE5] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                        >
                            {t("Διόρθωση →", "Fix →")}
                        </Link>
                    </div>
