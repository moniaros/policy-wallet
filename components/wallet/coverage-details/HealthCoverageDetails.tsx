      ...
      {health.waitingPeriods && health.waitingPeriods.length > 0 && (
        <div className="p-3 rounded-xl bg-white/60 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60">
          <div className="flex items-center gap-2.5 mb-2">
            ...
            <span className="text-sm font-semibold text-slate-700 dark:text-slate-300">{healthCopy.waitingPeriods}</span>
          </div>
        ...
        <div className="p-3 rounded-xl bg-white/60 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-sm font-semibold text-slate-700 dark:text-slate-300">{healthCopy.deductiblePerClaim}</span>
            </div>
            <span className="text-sm font-bold text-slate-900 dark:text-white">
