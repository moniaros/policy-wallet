            ...
            <div className="relative w-full max-w-lg bg-white dark:bg-stone-900 rounded-[48px] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-300">
                <div className="p-12">
                    <header className="mb-10">
                        ...
                        <h2 className="text-3xl font-black text-stone-900 dark:text-white tracking-tighter mb-2">Invite <span className="text-stone-400 dark:text-stone-500 italic">Collaborator.</span></h2>
                        <p className="text-base text-stone-500 dark:text-stone-400 font-medium">Send a magic link to invite a customer to their PolicyWallet.</p>
                    </header>

                    <div className="space-y-8">
                        <div>
                            <label className="text-[10px] font-black uppercase tracking-widest text-stone-400 mb-3 block pl-2">Customer Email</label>
                            <input
                                type="email"
                                value={email}
                        ...
                        <div>
                            <label className="text-[10px] font-black uppercase tracking-widest text-stone-400 mb-3 block pl-2">Initial Shared Context</label>
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                >
                                    ...
                                    <h3 className="text-sm font-black text-stone-900 dark:text-white tracking-tight mb-1">Upload-Only</h3>
                                    <p className="text-[10px] text-stone-400 font-medium leading-tight">Agent uploads policies to customer wallet.</p>
                                </button>
                                ...
                                >
                                    ...
                                    <h3 className="text-sm font-black text-stone-900 dark:text-white tracking-tight mb-1">Full Portfolio</h3>
                                    <p className="text-[10px] text-stone-400 font-medium leading-tight text-balance">Mutual visibility into all customer policies.</p>
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="pt-4 flex gap-4">
                            ...
                            >
                                {sending ? 'Dispatching...' : 'Dispatch Magic Link'}
                            </button>
                        </div>
                    </div>
                </div>
